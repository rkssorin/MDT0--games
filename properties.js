...
module.exports = {
	...
	primaryColor: css.color("#494949"),
	secondaryColor: css.color("#035970"),
	...
	// Dark: 'bg-dark'
	// Light: 'bg-light'
	// hell-grau: bg-hell-grau
	footerColor: "bg-hell-grau",
	...
	// Dark: 'bsi-icon-color-dark'
	// Light: 'bsi-icon-color-light'
	shareIconColor: "bsi-icon-color-dark",
	...
	// Dark: 'bsi-icon-hover-color-dark'
	// Light: 'bsi-icon-hover-color-light'
	shareIconHoverColor: "bsi-icon-hover-color-dark",
	...
	// Dark: 'bsi-btn-color-dark'
	// Light: 'bsi-btn-color-light'
	webcamImgMainButtonColor: "bsi-btn-color-secondary",
	...
	// Sharp corners: 'bsi-corner-sharp'
	// Rounded corners: 'bsi-corner-rounded'
	webcamImgBorderRadius: "bsi-corner-sharp",
