...
module.exports = (
	...
	// *****************
	textPartIdBadgeText = "text-part-Fjse59",
	textPartLabelBadge = "Badge text",
	// *****************
	...
	cx.contentElement
		...
		.withParts(
			...
			cx.part.plainText.withId(textPartIdStartText).withLabel(textPartLabelStartText),
			...
			cx.part.formattedText
				.withHtmlEditorConfig(require("../../../configs/editor/full.js"))
				.withId(textPartIdBadgeText)
				.withLabel(textPartLabelBadge),

			cx.part.link.withId(elementPartIdButtonReset).withLabel(elementPartLabelButtonReset),
			cx.part.formattedText
				.withHtmlEditorConfig(require("../../../configs/editor/full.js"))
				.withId(textPartIdIntroTop)
				.withLabel(textPartLabelIntroTop),
			cx.part.link.withId(elementPartIdButtonSendToForm).withLabel(elementPartLabelButtonSendToForm),
			...
			cx.part.image.withId(imagePartIdImage4).withLabel(imagePartLabelImage4),
			cx.part.image.withId(imagePartIdImage44).withLabel(imagePartLabelImage44)
		)
		.withDropzones(cx.dropzone.withDropzone("game_form_container").withAllowedElements(require("../../form-container-game/index.js")));
